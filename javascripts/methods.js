...
var whenArgs = function whenArgs() {
...
var Methods = {
  ...
  when: $.extend({}, Method, {args: whenArgs(), call: function(arg, callback, command, commandList) {
...
var PrivateMethods = {
  ...
  touch: function(callback, command, commandList) {
    ...
    $("#print-area").unbind("mousedown");
    $("#print-area").bind("touchstart", touchFunction);
    $("#print-area").bind("mousedown", touchFunction);
    callback(command, commandList);
  }
}
