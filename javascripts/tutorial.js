var shakeInstructions = function() {
      // don't add shake to mac app
      if (window.localStorage.getItem("mac-app") === 'true') {
        return "Here's something new: when. If you put a method inside when it will run every time you touch the screen. Try moving Daisy to the end of the screen using only when.";
      } else {
        return "Here's something new: when. If you put a method inside when it will run every time you shake (or touch). Try moving Daisy to the end of the screen using only when.";
      }
}
...
var tutorial = new Tutorial([
  {
    title: "First Step",
    description: "Hello and welcome to Daisy the Dinosaur!<br/><br/>"+
